...
export default function HeroPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 transition-colors duration-300">
      ...
      {/* Desktop Header */}
      <header
        className={`hidden md:block fixed top-0 left-0 right-0 z-50 border-b border-border/40 bg-background/80 backdrop-blur-lg transition-all duration-300 ${
      ...
      {/* Services Section */}
      <div id="services" className="pt-20 md:pt-32 transition-colors duration-300">
        <ServicesSection />
      </div>
